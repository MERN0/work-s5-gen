"""Regression tests for runner.py's generate_swe6(): building Swe6Config from
...
import artifacts.swe6.runner as runner_module
...
from artifacts.swe6.pipeline import PipelineResult
...
def test_run_reraises_swe6_errors_without_producing_a_result(tmp_path, monkeypatch):
    output_dir = tmp_path / "out"
    input_dir = tmp_path / "in"
    output_dir.mkdir()
    input_dir.mkdir()
