...
against, built from the raw dict runner.py's generate_sys5() assembles from a GenerationRequest.
...
from artifacts.sys5.exceptions import Sys5ConfigError
...
class Sys5Config(BaseModel):
    ...
    # --- standard fields (mirrors what runner.py's generate_sys5() already extracts from GenerationRequest) ---
