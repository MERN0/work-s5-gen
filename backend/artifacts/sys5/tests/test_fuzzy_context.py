...
from artifacts.sys5.excel.supporting_docs_loader import SupportingEntity
from artifacts.sys5.matching.fuzzy_context import enrich_requirement
from artifacts.sys5.models.requirement import FeatureMeta, Requirement
...
def _requirement(text: str) -> Requirement:
    return Requirement(
        ...
        matched_keyword="system qualification",
        feature=FeatureMeta(),
    )
