"""Console logging setup for standalone/dry runs (see runner.py's __main__ (removed - see tests/test_sys5_fixed_blocks.py)
...
def configure_logging(level: int = logging.INFO) -> None:
    ...
    logging.getLogger("artifacts.sys5").setLevel(level)
