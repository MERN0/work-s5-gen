...
from artifacts.sys5.excel.requirements_loader import load_requirements
from artifacts.sys5.excel.supporting_docs_loader import load_supporting_entities
from artifacts.sys5.llm.client import call_structured
from artifacts.sys5.matching.fuzzy_context import enrich_requirement
from artifacts.sys5.models.requirement import EnrichedRequirement
from artifacts.sys5.models.state import PipelineState, QueueItem
from artifacts.sys5.models.test_case import (
    GeneratedTestCase,
    SemanticVerdict,
    TestAspect,
    TestAspectPlan,
...
from artifacts.sys5.output.workbook_builder import build_workbook
from artifacts.sys5.paths import ensure_output_dir, resolve_intermediate_dir
from artifacts.sys5.prompts import generation_agent, planning_agent, qa_agent, verification_agent
from artifacts.sys5.prompts.registry import build_messages, is_agent_selected
from artifacts.sys5.validation import rules
...
def generate_test_case(state: PipelineState) -> dict:
    ...
    if not is_agent_selected(config.agent_chain, generation_agent.AGENT_NAME):
        logger.warning(
            "[sys5] %s not selected in agent_chain; cannot generate a test case for requirement %s.",
