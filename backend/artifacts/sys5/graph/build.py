...
Sys5Config.agent_chain, not from the graph's static shape. qa_agent is the
...
from artifacts.sys5.graph import nodes, routing
from artifacts.sys5.models.state import PipelineState
from artifacts.sys5.prompts import qa_agent
