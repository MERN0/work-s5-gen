...
from app.core.artifacts.swe6.config import AgentSpec
from app.core.artifacts.swe6.prompts import generation_agent, planning_agent, qa_agent, verification_agent
from app.core.artifacts.swe6.prompts.domains import resolve_domain_prompt
...
def resolve_prompt(agent_chain: list[AgentSpec], agent_name: str, domain: str = "") -> str:
    ...
    Either way, if `domain` (Swe6Config.domain) matches a known automotive
