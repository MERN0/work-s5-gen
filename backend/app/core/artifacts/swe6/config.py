...
against, built from the raw dict that swe6.py's generate() receives.
...
from app.core.artifacts.swe6.exceptions import Swe6ConfigError
...
class Swe6Config(BaseModel):
    ...
    # --- standard fields (mirrors what swe6.py's fixed block already extracts) ---
