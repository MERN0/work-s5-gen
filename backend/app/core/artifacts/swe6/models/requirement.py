"""Requirement-side data models: what we extract from SWE.1 software
requirement sheets and the supporting-doc context we attach to each
...
class Requirement(BaseModel):
    """One row from the requirements sheet that matched a SWE6 keyword."""
