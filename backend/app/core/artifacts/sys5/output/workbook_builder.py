...
file this pipeline may leave there, since sys5.py's fixed zip step zips
...
from app.core.artifacts.sys5.excel.supporting_docs_loader import load_supporting_sheets
from app.core.artifacts.sys5.formats.base import WorkbookBuildContext
from app.core.artifacts.sys5.formats.registry import get_format_profile
from app.core.artifacts.sys5.models.state import PipelineState
from app.core.artifacts.sys5.output.sheets.configurable_parameters_sheet import (
    write_configurable_parameters_sheet,
)
from app.core.artifacts.sys5.output.sheets.cover_page_sheet import write_cover_page_sheet
from app.core.artifacts.sys5.output.sheets.item_list_sheet import write_item_list_sheet
from app.core.artifacts.sys5.output.sheets.test_cases_sheet import write_test_cases_sheet
from app.core.artifacts.sys5.output.sheets.test_pattern_sheet import write_test_pattern_sheet

_INVALID_SHEET_CHARS = set('[]:*?/\\')
_INVALID_FILENAME_CHARS = set('<>:"/\\|?*')


def build_workbook(state: PipelineState, config: Sys5Config) -> Path:
    ...
    file_name = _safe_file_name(f"sys5_{test_cases_sheet_name}_{timestamp}.xlsx")
