...
from app.core.artifacts.sys5.graph import routing
from app.core.artifacts.sys5.models.test_case import ValidationResult


def _config(**overrides) -> Sys5Config:
    defaults = dict(output_dir="out", input_folder="in", max_validation_attempts=2, max_correction_attempts=1)
