...
ever contain the final .xlsx, because sys5.py's fixed zip step zips *every*
...
SYS5_PACKAGE_DIR = Path(__file__).resolve().parent
DEFAULT_RUNS_DIR = SYS5_PACKAGE_DIR / "_runs"
